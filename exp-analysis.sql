...
SELECT * FROM central_insights_sandbox.vb_rec_exp_final_iplxp_irex_model1_2_repeat LIMIT 5;
SELECT * FROM central_insights_sandbox.vb_module_impressions_iplxp_irex_model1_2_repeat LIMIT 5;
...
SELECT * FROM central_insights_sandbox.vb_rec_exp_final_iplxp_irex_model1_2_repeat; -- this will need to be the name of the current experiment
...
SELECT * FROM central_insights_sandbox.vb_module_impressions_iplxp_irex_model1_2_repeat ; -- this will need to be the name of the current experiment
...
SELECT * FROM central_insights_sandbox.vb_rec_exp_ids_hid_iplxp_irex_model1_2_repeat ; -- this will need to be the name of the current experiment
...
with module_metrics AS (
    SELECT exp_group,
           ...
           sum(watched_flag) as num_watched
    FROM central_insights_sandbox.vb_rec_exp_final
    WHERE click_container = 'module-recommendations-recommended-for-you' -- module of interest
