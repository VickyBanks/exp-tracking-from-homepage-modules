...
Variant2 <- read_csv('variation_2.csv')
...
remove_outliers(Experiment$num_starts)
remove_outliers(Experiment$num_watched)
...
###### Metric 1 - num starts ######
ggbetween_plot_starts <- Experiment %>%
...
Variant2_starts <- mean(Variant2$num_starts)
